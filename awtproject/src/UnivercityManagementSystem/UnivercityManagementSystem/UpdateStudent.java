...
public class UpdateStudent extends JFrame implements ActionListener{
    ...
    UpdateStudent() {
        ...
        try {
        	...
        	Connection c = DriverManager.getConnection(url, user, pass);
            String query = "select * from tbl_student where rollno='"+crollno.getSelectedItem()+"'";
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == submit) {
            ...
            try {
                Connection c = DriverManager.getConnection(url, user, pass);
                String query1 = "update tbl_student set Address='"+address+"', phone='"+phone+"', emails='"+email+"',  degree='"+course+"' where rollno='"+rollno+"'";
                Statement see = c.createStatement();
                see.executeUpdate(query1);
